      ...
      <div className="svcs">
        ...
        <div className="svc planning">
          ...
          <h2>Что именно умеет jabber.ru</h2>
            <p>Jabber. Мы умеем jabber, мгновенные сообщения. В будущем мы планируем запустить виртуальный почтовый сервис. А так же станцию слежения за астероидами в поясе Койпера. Но только после захвата мира.</p>
          ...
          <h2>Дополнительные услуги</h2>
            <p>Если у вас есть идеи связанные с jabber, а наш сервис их, на первый взгляд, не поддерживает, — напишите нам в support@conference.jabber.ru, и мы обязательно что-нибудь придумаем в индивидуальном порядке. Мы любим странные штуки и беспокойных людей.</p>       
        </div>
        </div>
      </div> 
    </Footer>
