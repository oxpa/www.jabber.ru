...
const conferences_jabber_ru = ["42fm", "4pda.ru", "bombus-talks", "bombus", "bombusmod", "clubjabber", "codingteam", "comp.lang.c", "coq", "c_plus_plus", "debian", "devel", "dotnet", "ejabberd", "emacs", "english", "erlang", "erlim", "freebsd", "freestyle", "gentoo", "golang", "haskell", "icfpc", "java", "javascript", "jtalk", "linux-talks", "linux", "lisp", "mint", "miranda-im", "miranda-ng", "mobile", "moto", "nethack", "ocaml", "pikabu", "programming", "psi-dev", "rock", "scala", "sex", "siemens", "support", "symbian", "sysadmins", "talks", "tcl", "tkabber", "vim", "web", "world_of_tanks", "xmonad", "yaroslavl"]
