...
const clients = [
    {Name: "Xabber", ImgUrl: "https://lh3.googleusercontent.com/5ZCn-z0We-puYjQ_t1m3RATzuakUurga5gRvWkpNVZHhmgdHvIQj_tpvs93CKebOqquT=h600", Description: "<p>Jabber Клиент с открытым исходным кодом, простым и аккуратным дизайном. Можно использовать одновременно с несколькими аккаунтами. Разрабатывается с целью быть лучшим андроид клиентом: не просто открытм, но и свободным от рекламы.</p> <p>Поддерживает в том числе:<ul><li>Modern material interface</li><li>Multiple accounts support</li><li>Multi user chat (MUC)</li><li>Chat history</li><li>Avatars</li><li>Notification setting for each contact</li><li>Stream compression</li><li>OTR, TLS, SSL, SASL</li><li>Message delivery receipts</li></ul></p>", tags: [5]},
    {Name: "Conversations", ImgUrl: "https://lh3.ggpht.com/ib4uM-oxW1Q8zSHib_UJVPaw73G5AHF1B3Swx_MXDXNzXf3hBDqgHnMWtYxChZ1I4fs=h600", Description: "<p>Открытый jabber клиент разработанный специально для Android 4+ </p><p>Создавался с целью быть как можно более красивым и удобным, без время для безопасности использования.</p><p>Поддерживает несколько аккаунтов, MUC, любые виды шифрования (OMEMO, OTR, PGP), отправку и приём изображений. Интегрируется с адресной книгой телефона. Почти не влияет на потребление электропитания. </p>", tags: [5]},
    {Name: "Yaxim", ImgUrl: "https://lh4.ggpht.com/9VvBWxJ7-S6SWb9_x8uVS8C_VVe9khX649Dzm_MWQ12a88hYexDCmMmgF4DuwEssHQ=h600", Description: "<p>Минималистичный клиент для Android.</p><p>Не смотря на простой дизайн, yaxim стремиться быть надёжным и полезным приложением. Из существенных плюсов можно отметить легковесность, поддержку конференций, подтверждения о доставке сообщений.</p> <p><a href='https://yaxim.org/download/'>https://yaxim.org/download/</a></p>", tags: [5] },
    {Name: "Adium", ImgUrl: "https://upload.wikimedia.org/wikipedia/commons/c/c5/AdiumX_screenshot.png", Description: "<p>Универсальный клиент мгновенного обмена сообщениями (мессенджер) для Mac OS X-систем, который поддерживает множество протоколов, и выпущен под лицензией GNU GPL.</p><p>Поддержка русского языка, использование многочисленных протоколов, tab-ы, уникальные возможности настройки интерфейса, возможность шифрования сообщений - вот далеко не полный список его возможностей.</p><p><a href='http://www.ixbt.com/td/adium.shtml'>http://www.ixbt.com/td/adium.shtml</a></p>", tags: [2]},
