...
const clients = [
    ...
    {Name: "Conversations", ImgUrl: "https://lh3.ggpht.com/ib4uM-oxW1Q8zSHib_UJVPaw73G5AHF1B3Swx_MXDXNzXf3hBDqgHnMWtYxChZ1I4fs=h600", Description: "<p>Открытый jabber клиент разработанный специально для Android 4+ </p><p>Создавался с целью быть как можно более красивым и удобным, без ущерба для безопасности использования.</p><p>Поддерживает несколько аккаунтов, MUC, основные виды шифрования (OMEMO, PGP), отправку и приём изображений. Интегрируется с адресной книгой телефона. Почти не влияет на потребление электропитания. </p>", tags: [5]},
