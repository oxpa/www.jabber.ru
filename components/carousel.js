...
const clients = [
    ...
    {Name: "Adium", ImgUrl: "https://upload.wikimedia.org/wikipedia/commons/c/c5/AdiumX_screenshot.png", Description: "<p>Универсальный клиент мгновенного обмена сообщениями (мессенджер) для системы macOS, который поддерживает множество протоколов, и выпущен под лицензией GNU GPL.</p><p>Поддержка русского языка, использование многочисленных протоколов, tab-ы, уникальные возможности настройки интерфейса, возможность шифрования сообщений - вот далеко не полный список его возможностей.</p><p><a href='http://www.ixbt.com/td/adium.shtml'>http://www.ixbt.com/td/adium.shtml</a></p>", tags: [2]},
