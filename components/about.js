...
export const About = Anchored(class extends React.Component {
    ...
    <Footer>
        ...
        <p>Да, мы - классные. Но мы можем быть куда лучше. Да и существуем только благодаря поддержке сообщества. Если у вас есть идеи, предложения или возможность помочь проекту, вы можете обратиться к нам через форму обратной связи или через jabber, написав в конференцию support@conference.jabber.ru.</p>
        <h1><Anchor id="tech">Часть техническая</Anchor></h1>
            ...
            <p>На ваш выбор. Мы рекомендует Xabber для телефона, встроенный Messages для OS X, для Windows: Psi+, VacuumIM, Miranda NG. Если вы пользуетесь Линуксом, то вы сами знаете, какой клиент поставить. Также мы разрабатываем веб-клиент <a href="https://chat.jabber.ru">Kaiwa</a>, который вы тоже можете попробовать.</p>
