...
export const About = Anchored(class extends React.Component {
    ...
    <Footer>
        ...
        <h1><Anchor id="tech">Часть техническая</Anchor></h1>
            ...
            <p>В феврале 2017 года мы запустили антиспам. Условия доставки сообщений достаточно просты: собеседник должен быть у вас в контакт листе и вы должны авторизовать его. Если вы уверены, что эти условия выполнены, а сообщения не проходят всё равно — напишите нам в <a href="xmpp:support@conference.jabber.ru">support@c.j.r</a>.</p>
            <h2><Anchor id="spam">От вас приходит спам! (You are sending spam!)</Anchor></h2>
            <p>Пожалуйста, свяжитесь с нами через форму обратной связи или в <a href="xmpp:support@conference.jabber.ru">support@c.j.r</a> и мы постараемся прекратить поток спама.</p>
            <p>Please report spam through feedback form at the bottom of this page or report spam to <a href="xmpp:support@conference.jabber.ru">support@c.j.r</a>. We'll do our best to stop spam.</p>
